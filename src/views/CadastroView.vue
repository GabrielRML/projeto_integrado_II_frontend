            ...
            <div style="padding: 2%; width: 100%; max-width: 700px;">
                <div class="row">
                    <div class="col-12" style="margin-top: 2rem;">
                        <FloatLabel>
                            <InputText id="login" v-model="this.form.login" :style="{ width: '100%' }" />
                ...
                <div class="row">
                    <div class="col-md-6 col-12" style="margin-top: 2rem;">
                        <FloatLabel>
                            <InputText id="firstName" v-model="this.form.firstName" :style="{ width: '100%' }" />
                            <label for="firstName">Nome</label>
                        </FloatLabel>
                    </div>
                    <div class="col-md-6 col-12" style="margin-top: 2rem;">
                        <FloatLabel>
                            <InputText id="lastName" v-model="this.form.lastName" :style="{ width: '100%' }" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12" style="margin-top: 2rem;">
                        <FloatLabel>
                            <Dropdown v-model="this.form.GENERO" :options="generos" optionLabel="genero" :style="{ width: '100%' }" />
                ...
                <div class="d-flex flex-column justify-content-center align-items-center" style="margin-top: 2rem;">
                    <SelectButton v-model="this.form.TIPO_USUARIO" :options="this.TIPOS_USUARIO" optionLabel="label" optionValue="value" aria-labelledby="basic" class="w-100" />
