<template>
    <div class="d-flex h-100">
        <!-- Esquerda -->
        <div class="d-flex flex-column justify-content-center align-items-center col-md-6 col-lg-6 col-xl-4 login-left">
        ...
        <!-- Direita -->
        <div class="col-md-6 col-lg-6 col-xl-8 d-flex flex-column justify-content-center align-items-center login-right">
