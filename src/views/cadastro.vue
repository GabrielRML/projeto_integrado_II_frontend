    ...
    <div class="d-flex h-100">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center h-100 col-md-6 col-lg-6 col-xl-8 col-12">
            ...
            <div style="padding: 2%;">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12" style="margin-top: 5%;">
                        <FloatLabel>
                ...
                <div  v-if="form.TIPO_USUARIO === 1" class="col-12" style="margin-top: 5%;">
                    <FloatLabel>
                ...
                <div v-if="form.TIPO_USUARIO === 2" class="col-12" style="margin-top: 5%;">
                    <FloatLabel>
                ...
                <div class="d-flex flex-column justify-content-center align-items-center col-md-12 col-lg-12 col-xl-12 col-12" style="margin-top: 5%;">
                    <SelectButton
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-3" style="margin-top: 5%;">
